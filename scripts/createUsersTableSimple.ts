...
async function createUsersTableSimple() {
  try {
    // Create users table using direct SQL through POST request
...
console.log('Starting users table setup with simple approach...');
